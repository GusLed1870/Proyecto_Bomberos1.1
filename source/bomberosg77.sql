...
(86, '36845658', 'Pedro Legizamón', '1993-07-20', 1135846875, 33, 'AB-', 1);
...
(2, 'Alfa', 'Salvamento en derrumbes', 0, 4),
(4, 'Bravo', 'Salvamento en derrumbes', 0, 5),
(6, 'Delta', 'Rescate de personas atrapadas en accidentes de tráfico', 1, 3),
(8, 'Foxtrot', 'Operativos de prevención', 1, 3),
(10, 'Hotel', 'Operativos de prevención', 1, 5),
(12, 'Juliet', 'Socorrer inundaciones', 0, 4),
...
(25, 'Whiskey', 'Rescate de personas atrapadas en accidentes de tráfico', 1, 8),
(28, 'Zulu', 'Incendios en viviendas, e industrias', 0, 5),
...
(34, 'Natalia', 'Incendios en viviendas, e industrias', 0, 7),
(35, 'Patrol', 'Incendios en viviendas, e industrias', 1, 34),
(36, 'Marshall', 'Rescate de personas atrapadas en accidentes de tráfico', 1, 33),
(37, 'Lion', 'Rescate de personas atrapadas en accidentes de tráfico', 1, 39),
(38, 'Poison', 'Incendios en viviendas, e industrias', 0, 4),
(39, 'Patriot', 'Rescates en ámbito montaña', 1, 9),
(40, 'Runa', 'Incendios en viviendas, e industrias', 1, 24),
(41, 'Sion', 'Salvamento en derrumbes', 1, 20);
...
(39, 'Cuartel IV Barracas', 'San Antonio 950', 356, 8524, '2345679832', 'barracascuart@gmail.com');
...
--
ALTER TABLE `bombero`
  MODIFY `id_bombero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT de la tabla `brigada`
--
ALTER TABLE `brigada`
  MODIFY `codBrigada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `cuartel`
--
ALTER TABLE `cuartel`
  MODIFY `codCuartel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
